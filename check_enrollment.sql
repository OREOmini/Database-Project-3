...
THEN
SET message = 'Enroll_failed.The course is beyond maxenrollment!';
SET output = 0;
ELSEIF NOT EXISTS(
SELECT L.UoSCode
from lecture L
...
THEN
SET notif = 'Course is not existed in the databse.';
SET output = 2;
...
if (t_error=1) 
then begin
set notif='ERROR occurs, ready to rollback';
rollback;
end;
else begin 
commit;
